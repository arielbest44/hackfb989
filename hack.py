...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Ariel 69 Channel             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |        TEAM : 69 Cyber Team            |"
    print Y+"  |             INSTAGRAM: Ariel Gaming              |"
    print GL+"  |---------------------------------------------|"
...
def main():
        ...
        life()
        print " "
        print RR+" G Ada Yang Cocok Anjng"
        print " "
def ariel(ariel_password):
  try:
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mAriel 69 Channel\033[91;1m
             Powered by:\033[97m Hacker Community
      """
